...
Un archgivo de configuración es un archivo YAML que contiene todos los ajustes de La Cabra. Permite guardar copias de seguridad de la configuración y puede ser más
